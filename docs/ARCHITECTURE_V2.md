...
All business logic lives here — decisions, arbitrage strategy, slippage modelling, profitability checks. On-chain primitives are only used to _execute_ once off-chain logic decides.

---

## 3. Excluded Functionality & What TrovePilot v2 Does _Not_ Do
...
sequenceDiagram
    ...
    LiquidationEngine->>TroveManager: batchLiquidateTroves() or liquidate()
